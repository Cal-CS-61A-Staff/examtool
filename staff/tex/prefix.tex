...
\markboth{}{Exam generated for <EMAIL ADDRESS HERE>}
...
This is your exam. Complete it either at \url{final.cs61a.org} or, if that doesn't work, on Google Forms. If either tool stops working, switch to the other one and continue taking the exam. We will merge your solutions together at the end of the exam, taking Google Form submissions in preference to submissions at \url{final.cs61a.org}.

This exam is intended for the student with email address <EMAIL>. If this is not your email address, notify course staff immediately, as each exam is different. Do not distribute this exam PDF even after the exam ends, as some students may be taking the exam in a different time zone.
...
\textbf{You may start your exam now. Your exam is due <AT THIS TIME>.} Go to the next page to begin.
